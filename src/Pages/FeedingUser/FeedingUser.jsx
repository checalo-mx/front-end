            ...
            <Container>
                ...
                <Box component="form">
                        ...
                        <CardContent>
                            <FormGroup>
                                <Grid container>
                                    ...
                                    <Grid item xs={2}>
                                        <Switch color="primary" onChange={handleUserTypeOfDiet} name="Vegetariano" checked={ "Vegetariano" === userInfo.typeOfDiet || false } />
                                    </Grid>
                                    <Grid item xs={10}>
                                        <FormLabel>Vegano</FormLabel>
                                    </Grid>
                                    <Grid item xs={2}>
                                        <Switch color="primary" onChange={handleUserTypeOfDiet} name="Vegano" checked={ "Vegano" === userInfo.typeOfDiet || false } />
                                    </Grid>
                                </Grid>
                            </FormGroup>
                        </CardContent>
                            ...
                            <FormGroup>
                                {Object.keys(userInfo.allergies[0]).map( allergy => (
                                    <Grid item container key={allergy}>
                                        ...
                                        <Grid item xs={2}>
                                            <Switch name={allergy} onChange={handleUserAllergies} checked={userInfo.allergies[0][allergy] || false} color="primary" />
                                        </Grid>
                                    </Grid>
                                ))}
                            </FormGroup>
                    ...
                    <Box textAlign="center">
                        <Button onClick={handleSubmit} type="submit" color="secondary" variant="contained" sx={{ my: "2em"}} >Guardar</Button>
                    </Box>
                </Box>
            </Container>
        </>
